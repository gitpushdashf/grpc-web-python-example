...
class RepeatHelloRequest(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    NAME_FIELD_NUMBER: builtins.int
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"count",b"count",u"name",b"name"]) -> None: ...
global___RepeatHelloRequest = RepeatHelloRequest
